/*
 * loader.c - STEP18: generyczny loader zasobow NE (rc_loader.c)
 *
 * Zmiany vs STEP17:
 *   - load_ski_strings / load_ski_bitmaps zastapione przez rc_init + rc_load_all
 *     (logika parsowania tablicy zasobow NE przeniesiona do rc_loader.c)
 *   - #include "rc_loader.h"
 *
 * Kompilacja:
 *   wcl -ml -l=dos -q loader.c pm_call.obj serial.obj rc_loader.obj -fe=loader.exe
 */
...
/* ============================================================
 * STEP18: load_ski_strings i load_ski_bitmaps usuniete.
 * Logika parsowania NE resource table przeniesiona do rc_loader.c.
 * Wywolania: rc_init(app_name) + rc_load_all(g_kcb_phys, g_bitmaps_phys).
 * Stale potrzebne nadal w main() dla alokacji bufora. */
#define MAX_BITMAPS     86
#define BMP_BUF_PARA    3584           /* 56KB = 3584 * 16 */
#define BMP_BUF_HDR     (4 + MAX_BITMAPS * 2)
/* ============================================================ */
#if 0  /* USUNIETE W STEP18 */
