...
LONG FAR PASCAL MainWndProc(HWND hWnd, unsigned msg, unsigned wParam, LONG lParam)
{
  switch (msg)
  {
    case WM_COMMAND:
...
HWND CreateMainWindow()
{
  ...
  HWND hWnd = CreateWindow(MainWndClass, MainWndClass, WS_OVERLAPPEDWINDOW, 0, 0, 320, 200, NULL, NULL, g_hInstance, NULL);
  ...
  if (hWnd)
  {
    ...
    AppendMenu(hSysMenu, MF_STRING, ID_HELP_ABOUT, "About");
  }
