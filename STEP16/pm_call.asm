; pm_call.asm - PM glue (STEP16)
;
; Nowe vs STEP15:
;   - IRQ1 handler (klawiatura): scan codes -> Virtual Keys -> PostMessage WM_KEYDOWN
;   - g_active_hwnd: HWND aktywnego okna (zapis z user.c, odczyt przez IRQ1)
;
