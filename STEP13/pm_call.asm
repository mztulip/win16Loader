...
; GDT size: 0x130 + 127*8 = 0x528 bytes
...
.no_app_data:
    ...
    ; SEL_BITMAPS (0x128): base = g_bitmaps_phys, limit=64KB-1 (statyczny)
    ; Zawiera bufor 86 sprite'ow 4bpp z SKI.EXE: [count(2)][pad(2)][offsets[86]*2][dane DIB]
    mov  eax, [_g_bitmaps_phys]
    test eax, eax
    jz   .no_bitmaps
    mov  [cs:gdt_bitmaps + 2], ax
    shr  eax, 16
    mov  [cs:gdt_bitmaps + 4], al
    mov  byte [cs:gdt_bitmaps + 5], 0x92  ; P=1, DPL=0, S=1, data RW
    mov  [cs:gdt_bitmaps + 7], ah
.no_bitmaps:
...
; GDT konczy sie na 0x130 + 127*8 = 0x528 bajtow -> GDT_LIMIT = 0x527
